...
# mem access: [38] 0x118-0x118 cl 4:24 | [62] 0x60-0x60 cl 1:32
# mem access: [43] 0x118-0x118 cl 4:24 | [93] 0x118-0x118 cl 4:24
and rdx, 0b1111111111000 # instrumentation
lock sub byte ptr [r14 + rdx], dl
# mem access: [38] 0xd0-0xd0 cl 3:16 | [62] 0x88-0x88 cl 2:8
# mem access: [43] 0x0 cl 0:0 | [93] 0x0 cl 0:0
dec bl
setnle cl
and rsi, 0b1111111111111 # instrumentation
movzx rsi, word ptr [r14 + rsi]
# mem access: [38] 0x18e5 cl 35:37 | [62] 0x4a4 cl 18:36
# mem access: [43] 0x18e5 cl 35:37 | [93] 0x4a4 cl 18:36
mov bl, 0
and rdi, 0b1111111111111 # instrumentation
sets byte ptr [r14 + rdi]
# mem access: [38] 0x118 cl 4:24 | [62] 0x60 cl 1:32
...
# mem access: [38] 0xd0 cl 3:16 | [62] 0x88 cl 2:8
# mem access: [43] 0x0 cl 0:0 | [93] 0x0 cl 0:0
and rsi, 0b1111111111111 # instrumentation
add qword ptr [r14 + rsi], rdx
# mem access: [38] 0x93-0x93 cl 2:19 | [62] 0x131b-0x131b cl 12:27
# mem access: [43] 0x0-0x0 cl 0:0 | [93] 0x7d5-0x7d5 cl 31:21
lfence
sub edi, -95
...
# mem access: [38] 0x1ba cl 6:58 | [62] 0x2 cl 0:2
...
# mem access: [38] 0x41a4 cl 6:36 | [62] 0x41a4 cl 6:36
# mem access: [43] 0x41a4 cl 6:36 | [93] 0x41a4 cl 6:36
and rdi, 0b1111111111111 # instrumentation
movsx rbx, word ptr [r14 + rdi]
# mem access: [38] 0x407c cl 1:60 | [62] 0x407c cl 1:60
...
# mem access: [38] 0x4000-0x4000 cl 0:0 | [62] 0x4000-0x4000 cl 0:0
# mem access: [43] 0x4000-0x4000 cl 0:0 | [93] 0x4000-0x4000 cl 0:0
and rcx, 0b1111111111111 # instrumentation
movzx esi, byte ptr [r14 + rcx]
# mem access: [38] 0x4000 cl 0:0 | [62] 0x4000 cl 0:0
# mem access: [43] 0x4000 cl 0:0 | [93] 0x4000 cl 0:0
and rax, 0b1111111111000 # instrumentation
add byte ptr [r14 + rax], bl
# mem access: [38] 0x4258-0x4258 cl 9:24 | [62] 0x4258-0x4258 cl 9:24
