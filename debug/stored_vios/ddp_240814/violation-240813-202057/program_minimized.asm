...
# mem access: [2] 0x445f cl 17:31 | [52] 0x445f cl 17:31
and rdx, 0b1111111111111 # instrumentation
...
# mem access: [2] 0x5d00 cl 52:0 | [52] 0x5d00 cl 52:0
add sil, 27 # instrumentation
and rcx, 0b1111111111111 # instrumentation
cmovnp ecx, dword ptr [r14 + rcx]
# mem access: [2] 0x571a cl 28:26 | [52] 0x571a cl 28:26
or rbx, 0b1000000000000000000000000000000 # instrumentation
bsr rbx, rbx
and rdx, 0b1111111111111 # instrumentation
and rax, qword ptr [r14 + rdx]
# mem access: [2] 0x4213 cl 8:19 | [52] 0x4213 cl 8:19
and rax, 0b1111111111111 # instrumentation
or qword ptr [r14 + rax], 0b1000000000000000000000000000000 # instrumentation
# mem access: [2] 0x5000-0x5000 cl 0:0 | [52] 0x5000-0x5000 cl 0:0
bsf rdi, qword ptr [r14 + rax]
# mem access: [2] 0x5000 cl 0:0 | [52] 0x5000 cl 0:0
and rbx, 0b1111111111111 # instrumentation
mov rdx, qword ptr [r14 + rbx]
# mem access: [2] 0x401e cl 0:30 | [52] 0x401e cl 0:30
and rdi, 0b1111111111111 # instrumentation
or dword ptr [r14 + rdi], 1 # instrumentation
# mem access: [2] 0x4002-0x4002 cl 0:2 | [52] 0x4002-0x4002 cl 0:2
and edx, dword ptr [r14 + rdi] # instrumentation
# mem access: [2] 0x4002 cl 0:2 | [52] 0x4002 cl 0:2
...
# mem access: [2] 0x401e cl 0:30 | [52] 0x401e cl 0:30
and rcx, 0b1111111111111 # instrumentation
or word ptr [r14 + rcx], 0b1000000000000000 #
...
# mem access: [2] 0x4046 cl 1:6 | [52] 0x4046 cl 1:6
sbb cl, bl
and rdx, 0b1111111111111 # instrumentation
